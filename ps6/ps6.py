...
WORDLIST_FILENAME = '/home/suspect-0/.config/spyder-py3/ps6/words.txt'
...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        '''
        encryptValues = self.build_shift_dict(shift)
        encryptedStr = ''
...
class PlaintextMessage(Message):
    def __init__(self, text, shift):
        Message.__init__(self, text)  #calling parent constructor
